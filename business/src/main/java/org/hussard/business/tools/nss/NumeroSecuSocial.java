...
import org.hussard.business.tools.nss.elements.lieu.Factory;
import org.hussard.business.tools.nss.elements.lieu.LieuNaissance;
...
public class NumeroSecuSocial {
    ...
    private String getCle(String nir) {
        return ElementFactory.get(EnumElement.CLE).value(nir);
    }

    private String getNomOrdreNaissance(String nir) {
        return ElementFactory.get(EnumElement.ORDRE).value(nir);
    }

    private String getMoisNaiss(String nir) {
        return ElementFactory.get(EnumElement.MOIS).value(nir);
    }

    private String getAnneeNaiss(String nir) {
        return ElementFactory.get(EnumElement.ANNEE).value(nir);
    }

    private String getSexe(String nir) {
        return ElementFactory.get(EnumElement.SEXE).value(nir);
    }
}
